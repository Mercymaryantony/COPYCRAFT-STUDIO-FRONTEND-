            ...
            <div className="row">
                <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <div className="row g-3">
                        ...
                        <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                            <label htmlFor="" className="form-label">BINDING</label>
                            <select name="binding" id="" className="form-control"  value={data.binding} onChange={inputHandler}>
                        ...
                        <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                            <label htmlFor="" className="form-label">FRONT PAGE COLOR</label>
                            <input type="text" className="form-control" name='frontcolor' value={data.frontcolor} onChange={inputHandler} />
                        </div>
                         <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
